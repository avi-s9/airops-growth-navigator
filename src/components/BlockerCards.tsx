...
/* ------------------------------------------------------------------ */
/*  Lightbox – accessible modal for expanded screenshots               */
/* ------------------------------------------------------------------ */
...
function Lightbox({
  ...
  // Capture previous focus & autofocus close button
  useEffect(() => {
  ...
  // Focus trap: only the close button is interactive inside
                ...
                <div className="flex-1 p-5">
                  ...
                  >
                    ...
                    {b.screenshots?.map((row, ri) => (
                      ...
                      >
                        {row.map((shot, si) => (
                          <ScreenshotImage key={si} shot={shot} onOpen={setLightboxSrc} />
                        ))}
                      </div>
                    ))}
                  </div>
