...
const funnelData = [
  ...
  { step: 8, name: "See Opportunities", users: 214, pct: 63.5, dropoff: 22, dropoffPct: 9.3, time: "5s", zone: "tollbooth" as const, hypothesis: "Forces a premature choice between Content Creation and Content Refresh. Users don't know enough yet to pick, and it feels like a commitment they're not ready to make." },
