...
const experiments = [
  {
    ...
    rationale:
      "The 28% drop is hitting users who already completed 10 onboarding steps. These are high-intent people. They didn't quit during the harder setup phases; they quit at the moment of activation. That tells you the barrier is mechanical - too many clicks, wait times between steps, unclear what to do next. These users already proved they're interested by completing 10 steps. When the cause is mechanical, fixing it tends to recapture a big chunk of the lost users. We wouldn't expect to recover all 28% - some will bounce if the content quality doesn't meet expectations. But cutting a friction-driven drop roughly in half is a reasonable baseline.",
    changes: [
